...
class WindFormatter(FormatterInterface):

    def format(self):
        self.setConstants('wind', '../../data/data_raw/wind', '../../data/data_processed/{area}/wind',
                          'wind-power-{country}_{year}_hourly.xls',
                          'wind-power-{country}_{year}_hourly.csv')
